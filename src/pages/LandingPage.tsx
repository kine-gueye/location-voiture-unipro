...
const LandingPage = () => {
  ...
  const voitures = [
    { id: 1, nom: "Toyota Prado", prix: "50 000 FCFA", categorie: "SUV", image: "" },
    { id: 2, nom: "Mercedes Classe C", prix: "75 000 FCFA", categorie: "Luxe", image: "" },
    { id: 3, nom: "Hyundai Accent", prix: "30 000 FCFA", categorie: "Économique", image: "" },
  ];
    ...
    <div className="bg-background min-h-screen">
      ...
      <header className="container mx-auto px-6 py-16 text-center">
        ...
        <p className="text-gray-600 text-xl mb-10 max-w-2xl mx-auto">
          Découvrez notre large gamme de véhicules pour tous vos déplacements à Dakar et partout au Sénégal.
        </p>
